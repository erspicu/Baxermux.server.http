...
//ref http://carlosqt.blogspot.tw/2011/05/stopwatch-class-for-java.html
...
public class Stopwatch
{
	...
	/**
	 * Gets the total elapsed time measured by the current instance, in milliseconds. 10000 Ticks = 1 millisecond (1000000 nanoseconds)
	 */
	...
	/**
	 * Gets the total elapsed time measured by the current instance, in seconds. 10000000 Ticks = 1 second (1000 milliseconds)
	 */
	...
	/**
	 * Gets the total elapsed time measured by the current instance, in minutes. 600000000 Ticks = 1 minute (60 seconds)
	 */
	...
	/**
	 * Gets the total elapsed time measured by the current instance, in hours. 36000000000 Ticks = 1 hour (60 minutes)
	 */
	...
	/**
	 * Gets the total elapsed time with format 00:00:00.0000000 = 00:mm:ss.SSS + #### Ticks
	 * 
	 * @param elapsedTicks
